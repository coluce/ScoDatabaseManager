...
begin
  ...
  vControllerParam.SetParam('INI', 'DEFAULT_PATH',
    ExtractFilePath(FView.edtLocalDestino.Text));
  vControllerParam.SetParam('INI', 'DEFAULT_FILE_NAME',
    ExtractFileName(FView.edtLocalDestino.Text));
...
begin
  ...
  begin
    ...
    begin
      ...
      FView.SynMemo1.Lines.Add(FModelLayout.DataSet.FieldByName('LAYOUT')
        .AsString);
      FView.SynMemo1.Text := FView.SynMemo1.Text.Replace('#server',
        FDatabase.Server.IP, [rfReplaceAll, rfIgnoreCase]);
      FView.SynMemo1.Text := FView.SynMemo1.Text.Replace('#database',
...
procedure TControllerIniFile.PrepareData;
  ...
  begin
    ...
    while not FModelLayout.DataSet.Eof do
    begin
      FView.ComboBoxLayout.Items.Add(FModelLayout.DataSet.FieldByName('NAME')
        .AsString);
      FModelLayout.DataSet.Next;
    end;
  ...
  begin
    vControllerParam := TControllerFactory.IniManager;
    vDirectory := vControllerParam.GetParam('INI', 'DEFAULT_PATH',
      ExtractFilePath(ParamStr(0)));
    vFileName := vControllerParam.GetParam('INI', 'DEFAULT_FILE_NAME',
      'ALTERDB.INI');
